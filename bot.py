...
async def on_message(message):
    ...
    if message.author != client.user:
      if ("2013 nazuna" in message.content.lower()) or ("2013 nito" in message.content.lower()):
        ...
        await client.send_message(message.channel,"Richard \"Dick\" Suckle \n **Born**: January 1969")
...
Asahi ga kimi o torimodosu made wa bokutachi no jikan""")
        ...
        await client.send_file(message.channel,random.choice(["absolutely stunning little nito.png", "adorablenazu.png", "amazingnito.png", "angelicnito.png", "beautifulnito.png", "brightnito.png", "cheerfulnito.png", "cutenito.png", "delicious nazu.png", "delightfulnito.png", "faitonito.png", "fuwanito.png", "gentlenazu.png", "gorgeousnito.png", "i think i'm having a stroke.png", "i-is_that_a_love_letter_for_me.png", "i_would_die_for_you_nito.png", "im-suddenly-a-furry.png", "incrediblenito.png", "lovelynito.png", "lovingnito.png", "my goodest bad boy nito.png", "mynazu.png", "nito you make me feel so loved.png", "ohwonderfulnazu.png", "please feed me nito.png", "rawrnito.png", "sillynazu.png", "strongnito.png", "sweetnazu.png", "talentednito.png", "this pic is from our marriage ceremony.png", "usaginito.png", "you are so handsome nito.png", "you shine so brightly my dear nito.png"]))
